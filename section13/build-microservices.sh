...
BASE_DIR="/d/Intellij_Projects/Microservices/section13"

# List of microservices
SERVICES=("accounts" "cards" "loans" "message" "configserver" "eurekaserver" "gatewayserver")
...
for SERVICE in "${SERVICES[@]}"; do
    ...
    IMAGE_NAME="zeeshan2424/$SERVICE:s13"  # Define the Docker image name
